...
public class IMEI {
    public static void main(String[] args) {
        try {
            ObjectInputStream in = new ObjectInputStream(new FileInputStream("/Users/shunlihan/Downloads/apps/com.tencent.mm/r/MicroMsg/systemInfo.cfg"));
            Object DL = in.readObject();
            HashMap hashWithOutFormat = (HashMap) DL;
//            ObjectInputStream in1 = new ObjectInputStream(new FileInputStream("/Users/shunlihan/Downloads/apps/com.tencent.mm/r/MicroMsg/CompatibleInfo.cfg"));
//            Object DJ = in1.readObject();
//            HashMap hashWithOutFormat1 = (HashMap) DJ;
            String s = "1234567890ABCDEF"; // 取手机的IMEI
